        ...
        <div className='px-2 lg:ml-[260px] md:px-7 pt-5'>
            ...
            <div className='flex flex-wrap w-full'>
                ...
                <div className=" p-4 bg-white-100 shadow-sm shadow-black-100 h-screen lg:h-auto px-3 py-2 lg:rounded-md text-black-500">
                         <div className="flex justify-between items-center">
                         <h1 className="text-black-500 font-semibold text-xl mb-4 ">Add New Brand</h1>
                       ...
                       <div className="flex flex-col w-full fap-1 mb-3">
                        ...
                        <input name="model_name" id="name" className="px-4 py-2 mt-2 focus:border focus:border-primary-500 outline-none rounded-md text-black-500 bg-primary-100" type="text" placeholder="Brand name" />
                    </div>
                    <div>
