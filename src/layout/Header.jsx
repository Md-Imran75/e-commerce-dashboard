        ...
        <div className='flex justify-center items-center gap-8 relative'>
          <div className='flex justify-center items-center '>
            <div className='flex justify-center items-center gap-3  '>
              ...
              {
                userInfo.role === 'admin' ? <img className='w-[45px] h-[45px] rounded-full overflow-hidden' src="http://localhost:3000/images/logo.png" alt="" /> : <img className='w-[45px] h-[45px] rounded-full overflow-hidden' src={userInfo?.image} alt="" />
              }
            </div>
          </div>
        </div>
